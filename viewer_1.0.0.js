...
// HACK: read exif and rotate image
new EXIF(image, {
  ...
  gps: false,
    ...
    var rotates = { 6: 90, 3: 180, 8: -90 };

    if (tags.Orientation && rotates[tags.Orientation]) {
      _this2.imageData.rotate = rotates[tags.Orientation];
      _this2.initialImageData.rotate = rotates[tags.Orientation];
    }
